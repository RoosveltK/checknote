	              ...
	              <div class="col-sm-12">
	                <div class="card">
	                  <div class="card-body">
	                    ...
	                    <form id="form-horizontal" class="form-horizontal form-wizard-wrapper wizard clearfix" role="application"><div class="steps clearfix"><ul role="tablist"><li role="tab" class="first done" aria-disabled="false" aria-selected="false"><a id="form-horizontal-t-0" href="#form-horizontal-h-0" aria-controls="form-horizontal-p-0"><span class="number">1.</span> Seller Details</a></li><li role="tab" class="done" aria-disabled="false" aria-selected="false"><a id="form-horizontal-t-1" href="#form-horizontal-h-1" aria-controls="form-horizontal-p-1"><span class="number">2.</span> Company Document</a></li><li role="tab" class="current" aria-disabled="false" aria-selected="true"><a id="form-horizontal-t-2" href="#form-horizontal-h-2" aria-controls="form-horizontal-p-2"><span class="current-info audible">current step: </span><span class="number">3.</span> Bank Details</a></li><li role="tab" class="disabled last" aria-disabled="true"><a id="form-horizontal-t-3" href="#form-horizontal-h-3" aria-controls="form-horizontal-p-3"><span class="number">4.</span> Confirm Detail</a></li></ul></div><div class="content clearfix">
	                      <h3 id="form-horizontal-h-0" tabindex="-1" class="title">Seller Details</h3>
	                      <fieldset id="form-horizontal-p-0" role="tabpanel" aria-labelledby="form-horizontal-h-0" class="body" aria-hidden="true" style="display: none;">
	                        <div class="row">
	                          <div class="col-md-6">
	                      ...
	                      <h3 id="form-horizontal-h-1" tabindex="-1" class="title">Company Document</h3>
	                      ...
	                      <h3 id="form-horizontal-h-2" tabindex="-1" class="title current">Bank Details</h3>
	                      <fieldset id="form-horizontal-p-2" role="tabpanel" aria-labelledby="form-horizontal-h-2" class="body current" aria-hidden="false" style="">
	                        <div class="row">
	                          <div class="col-md-6">
	                            <div class="form-group row">
	                      ...
	                      <h3 id="form-horizontal-h-3" tabindex="-1" class="title">Confirm Detail</h3>
	                      <fieldset id="form-horizontal-p-3" role="tabpanel" aria-labelledby="form-horizontal-h-3" class="body" aria-hidden="true" style="display: none;">
	                        <div class="p-3">
